...
func (q *Queries) GetIssueUsageSummary(ctx context.Context, taskID pgtype.UUID) (GetIssueUsageSummaryRow, error) {
	row := q.db.QueryRow(ctx, getIssueUsageSummary, taskID)
